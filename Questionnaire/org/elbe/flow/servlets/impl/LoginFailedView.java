...
/**
 * View to display message after failed login.
 * 
 * Created on 01.05.2003
 * @author Luthiger
 */
public class LoginFailedView extends AbstractXSLView {
	private static final String XSL_FILE = "stylesheets/failedLogin.xsl";

	/**
	 * LoginFailedView constructor.
	 * 
	 * @param inContext Context
	 * @param inMessage String
	 */
	public LoginFailedView(Context inContext, String inMessage) {
		super(inContext);
