...
/**
 * Displays the feedback view.
 * 
 * Created on 02.05.2003
 * @author Luthiger
 */
public class FeedbackView extends AbstractHtmlView {
	//constants
	private static final String HTML_FILE = "pages/feedback.htm";

	/**
	 * FeedbackView default constructor.
	 * @param inContext
	 */
	public FeedbackView(Context inContext) {
		super(inContext);
