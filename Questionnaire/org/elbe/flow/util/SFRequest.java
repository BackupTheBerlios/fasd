...
/**
 * This class sends a HTTP Request to the SourceForge site (sf.net)
 *  
 * Created on 30.04.2003
 * @author Luthiger
 */
public class SFRequest extends AbstractHTTPRequest implements UserCheck {
	private final static String PROTOCOL = "http";
	private final static String HOST = "www.sourceforge.net";
	private final static int PORT = 80;
	private final static String FILE = "/users/";
	private final static int SITE_CODE = 1;
	...
	public String getResponse(String inUserName, Context inContext) throws QuestionnaireWarningException {
		...
		try {
			...
			String lMessage = getMessage("org.elbe.flow.msg.noConnection1", inContext) + " SourceForge " + getMessage("org.elbe.flow.msg.noConnection2", inContext);
