...
/**
 * Task to display the questionnaire.
 * 
 * Created on 22.04.2003
 * @author Luthiger
 */
public class QuestionsShowTask extends AbstractQuestionsShowTask {

	/**
	 * QuestionsShowTask default constructor.
	 * 
	 */
	public QuestionsShowTask() {
		super();
	}

	protected HtmlView getView(Context inContext) {
		return new QuestionsView(inContext, true);
	}
}
