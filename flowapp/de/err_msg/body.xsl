...
<xsl:template match="Error">
		<table width="100%" border="0" cellspacing="10">
 			<tr>
				<td>
                    <img src="./images/logo_mini_eng.gif" alt="Universität Zürich" align="right"/>
                    <h2>FASD Survey</h2>
                </td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<input class="button" name="button" type="button" value="Zurück" onClick="javascript:history.back();history.back()"/>
				</td>
			</tr>
